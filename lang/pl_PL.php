...
"PLUGIN_DISABLED"   => "Wyłączona [n]",
"SHOW_PLUGINS"		  	=> "Zarządzanie w<em>t</em>yczkami",
"PLUGIN_NAME" 	  		=> "Nazwa",
"PLUGIN_DESC" 	  		=> "Opis",
"PLUGIN_VER" 			=> "Wersja",
"PLUGIN_UPDATED"		=> "Zmieniono stan wtyczki [y]",
/***********************************************************************************
 * SINCE Version 2.03
***********************************************************************************/

// zamiana polskich znaków diakrytycznych w automatycznie generowanych linkach podstron
